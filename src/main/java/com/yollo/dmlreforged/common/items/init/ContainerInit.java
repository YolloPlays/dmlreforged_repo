...
public class ContainerInit {
	...
	public static final RegistryObject<MenuType<ExtractionChamberContainer>> EXTRACTION_CHAMBER = CONTAINERS.register("extraction_chamber", () -> new MenuType<>(ExtractionChamberContainer::new));
